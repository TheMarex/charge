#ifndef CHARGE_COMMON_INTEGER_RANGE_HPP
#define CHARGE_COMMON_INTEGER_RANGE_HPP
// Ported from OSRM include/util/integer_range.hpp
// As replacement for broken boost::irange on Ubuntu trusty
