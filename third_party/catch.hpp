...
namespace Catch {
    ...
    struct FatalConditionHandler {
        ...
        static char altStackMem[32768]; // was SIGSTKSZ, using fixed size for glibc 2.34+ compatibility
    ...
    char FatalConditionHandler::altStackMem[32768] = {}; // was SIGSTKSZ, using fixed size for glibc 2.34+ compatibility
